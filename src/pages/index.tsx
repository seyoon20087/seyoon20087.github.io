...
*/
            ...
            .table-borderless > :not(:first-of-type) {
              border-top-width: 0;
            }
            ...
            .input-group:not(.has-validation)
              > .dropdown-toggle:nth-last-of-type(n + 3) {
              border-top-right-radius: 0;
              border-bottom-right-radius: 0;
            }
            .input-group.has-validation
              > :nth-last-of-type(n
                + 3):not(.dropdown-toggle):not(.dropdown-menu),
            .input-group.has-validation
              > .dropdown-toggle:nth-last-of-type(n + 4) {
              border-top-right-radius: 0;
              border-bottom-right-radius: 0;
            }
            .input-group
              > :not(:first-of-type):not(.dropdown-menu):not(.valid-tooltip):not(.valid-feedback):not(.invalid-tooltip):not(.invalid-feedback) {
              margin-left: -1px;
